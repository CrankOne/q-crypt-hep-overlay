...
#SRC_URI="https://root.cern.ch/download/root_v6.08.06.source.tar.gz"
...
src_prepare() {
	...
	# removed: "${FILESDIR}"/${PN}-6.00.01-llvm.patch  # since LLVM no longer
	#		   supports building with configure.
	# updated: "${FILESDIR}"/${PN}-6.00.01-nobyte-compile.patch
	# removed: "${FILESDIR}"/${PN}-6.04.06-gsl2.patch (TODO: update)
	epatch \
